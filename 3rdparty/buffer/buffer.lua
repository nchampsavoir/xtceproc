...
local platform = require "3rdparty.buffer.platform"
...
--- Extract a part of the buffer as a Lua string
function Buffer:substr(offset, len)
    return ffi.string(self.tbuffer.data + offset, len)
end
